...
# # E2E
# # ------------------------------------------------------------
# def test_slice_source_normalize_orderbook_snapshot_e2e(
#     tmp_path: Path,
#     monkeypatch: pytest.MonkeyPatch,
# ):
#     """
#     Normalize(v2) + Meta + SliceSource + OrderBookRebuild 的完整 E2E
#     """
#
#     # ------------------------------------------------------------
...
#     # 2) parse
#     # ------------------------------------------------------------
#     t_order = parse_events_arrow(pq.read_table(order_path), exchange="sh", kind="order")
#     t_trade = parse_events_arrow(pq.read_table(trade_path), exchange="sh", kind="trade")
#
#     # ------------------------------------------------------------
#     # 3) Normalize
#     # ------------------------------------------------------------
